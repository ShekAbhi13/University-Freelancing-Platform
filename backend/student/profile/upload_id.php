        ...
        <div class="form-container">
            ...
            <?php if ($student['id_document']): ?>
                <div class="status-box">
                    <div class="status-item">
                        ...
                        <span class="status-value <?php echo strtolower($student['id_verified']); ?>">
                            <?php echo ucfirst($student['id_verified']); ?>
                        </span>
                    </div>
                    <div class="status-item">
                        <span class="status-label">Uploaded File:</span>
                        <span><?php echo htmlspecialchars($student['id_document']); ?></span>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="id_document">Student ID Document</label>
                ...
                <div class="note-box">
                    ...
                    <p>Upload a clear photo or scan of your student ID. This is required for identity verification and to ensure platform security.</p>
                </div>
